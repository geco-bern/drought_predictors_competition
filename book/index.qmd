...
When reading this book as formal course work the requested format for handing in the exercises as listed in @sec-exercises is a single R markdown file (see REF), including its rendered html file.
